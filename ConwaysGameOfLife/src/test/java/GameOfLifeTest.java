...
public class GameOfLifeTest {
    ...
    public void testCountAliveNeighbors() {
        ...
        assertEquals(5, game.countAliveNeighbors(7, 6));
        assertEquals(8, game.countAliveNeighbors(7, 7));
        assertEquals(3, game.countAliveNeighbors(6, 3));
        assertEquals(2, game.countAliveNeighbors(5, 1));
        assertEquals(3, game.countAliveNeighbors(9, 7));
        assertEquals(1, game.countAliveNeighbors(9, 9));
    }
}
